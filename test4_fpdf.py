...
long_text = "Matched Skills: Python, SQL, Machine Learning, Deep Learning, AWS, GCP, Azure, Docker, Kubernetes, NLP, Computer Vision, Pandas, NumPy, Scikit-learn, TensorFlow, PyTorch, Keras, Matplotlib, Seaborn, FastAPI, Flask, Django"
pdf.multi_cell(w=0, h=10, text=long_text, new_x="LMARGIN", new_y="NEXT")
